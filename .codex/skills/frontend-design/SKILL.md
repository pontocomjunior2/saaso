...
## [target] Selective Reading Rule (MANDATORY)
...
### [stop] DEFAULT TENDENCIES TO AVOID (ANTI-SAFE HARBOR):

| AI Default Tendency | Why It's Bad | Think Instead |
|---------------------|--------------|---------------|
| **Bento Grids (Modern Cliche)** | Used in every AI design | Why does this content NEED a grid? |
...
Key properties:
 ...
 [!] **WARNING:** Standard blue/white glassmorphism is a modern cliche. Use it radically or not at all.
```
