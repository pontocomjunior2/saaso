...
[debug] Symptom: [what's happening]
[target] Root cause: [why it's happening]
[ok] Fix: [the solution]
[guard] Prevention: [how to avoid in future]
```

---

### 4. [checklist] REVIEW Mode
...
### 3. [brainstorm] MENTAL MODEL SYNC
