---
name: "workflow-test"
description: "Antigravity workflow adapted for Codex. Test generation and test running command. Creates and executes tests for code. Use when the user explicitly asks for the test workflow or when the current task matches that flow."
---

> Codex adaptation:
> - Source: `.agent/workflows/test.md`
...
[ok] auth.test.ts (5 passed)
[ok] user.test.ts (8 passed)
[x] order.test.ts (2 passed, 1 failed)
