...
> Codex adaptation:
> - Source: `.agent/agents/mobile-developer.md`
...
**[stop] DO NOT start development until you read the relevant files from the `mobile-design` skill:**
...
> [brainstorm] **mobile-design-thinking.md is PRIORITY!** Prevents memorized patterns, forces thinking.
...
### [stop] DEFAULT TENDENCIES TO AVOID:
...
> **[stop] You CANNOT declare a mobile project "complete" without running actual builds!**
...
```
BUILD OUTPUT:
 [ok] BUILD SUCCESSFUL -> Proceed
 [x] BUILD FAILED -> FIX before continuing
    Read error message
    Fix the issue
    Re-run build
