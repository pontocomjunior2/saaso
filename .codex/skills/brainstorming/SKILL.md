...
## [brainstorm] Dynamic Question Generation

**[stop] NEVER use static templates.** Read `dynamic-questioning.md` for principles.
...
|-------|--------|--------------|----------|
| [Agent Name] | [ok][cycle][wait][x][!] | [Task description] | [% or count] |
...
| [cycle] | Running | Currently executing |
| [wait] | Waiting | Blocked, waiting for dependency |
| [x] | Error | Failed, needs attention |
...
| **Visual** | Use emojis ([ok][cycle][wait][x]) for quick scanning |
