...
description: "Antigravity workflow adapted for Codex. Plan and implement UI Use when the user explicitly asks for the ui ux pro max workflow or when the current task matches that flow."
---

> Codex adaptation:
> - Source: `.agent/workflows/ui-ux-pro-max.md`
...
| Rule | Do | Don't |
|------|----|----- |
| **No emoji icons** | Use SVG icons (Heroicons, Lucide, Simple Icons) | Use emojis like [design] [ship]  as UI icons |
