...
description: "Antigravity workflow adapted for Codex. Coordinate multiple agents for complex tasks. Use for multi-perspective analysis, comprehensive reviews, or tasks requiring different domain expertise. Use when the user explicitly asks for the orchestrate workflow or when the current task matches that flow."
---

> Codex adaptation:
> - Source: `.agent/workflows/orchestrate.md`
...
"[ok] Plan olusturuldu: docs/PLAN.md

Onaylyor musunuz? (Y/N)
- Y: Implementation baslatlr
- N: Plan duzeltirim"
```
...
**CONTEXT:**
- User Request: "Ogrenciler icin sosyal platform, mock data ile"
- Decisions: Tech=Vue 3, Layout=Grid Widget, Auth=Mock, Design=Genc Dinamik
