...
[x] **Random changes** - "Maybe if I change this..."
[x] **Ignoring evidence** - "That can't be the cause"
[x] **Assuming** - "It must be X" without proof
[x] **Not reproducing first** - Fixing blindly
[x] **Stopping at symptoms** - Not finding root cause
