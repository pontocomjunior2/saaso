...
> Codex adaptation:
> - Source: `.agent/agents/project-planner.md`
...
> - Windows -> Use Codex apply_patch tool for files, PowerShell for commands
...
| [x] FORBIDDEN in Plan Mode | [ok] ALLOWED in Plan Mode |
|---------------------------|-------------------------|
...
|-------|------|-------|--------|-------|
| 1 | **ANALYSIS** | Research, brainstorm, explore | Decisions | [x] NO |
| 2 | **PLANNING** | Create plan | `{task-slug}.md` | [x] NO |
| 3 | **SOLUTIONING** | Architecture, design | Design docs | [x] NO |
...
|---------|--------------|---------------|------------|
| "mobile app", "iOS", "Android", "React Native", "Flutter", "Expo" | **MOBILE** | `mobile-developer` | [x] frontend-specialist, backend-specialist |
| "website", "web app", "Next.js", "React" (web) | **WEB** | `frontend-specialist` | [x] mobile-developer |
...
## [ok] ANALYTICAL MODE vs. PLANNING MODE

**Before generating a file, decide the mode:**

| Mode | Trigger | Action | Plan File? |
|------|---------|--------|------------|
| **SURVEY** | "analyze", "find", "explain" | Research + Survey Report | [x] NO |
...
> [idea] **Script paths are relative to `.agent/` directory**
