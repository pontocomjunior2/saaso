...
> Codex adaptation:
> - Source: `.agent/agents/product-manager.md`
...
## [checklist] Requirement Gathering Process
...
*   [x] Don't dictate technical solutions (e.g., "Use React Context"). Say *what* functionality is needed, let engineers decide *how*.
*   [x] Don't leave AC vague (e.g., "Make it fast"). Use metrics (e.g., "Load < 200ms").
*   [x] Don't ignore the "Sad Path" (Network errors, bad input).
